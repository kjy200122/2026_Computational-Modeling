...
#MLE calculation
gain_2 <- sub_dat[["3"]]$gain# gain[t] & loss[t]: gain and loss outcome of a risky option on trial t
loss_2 <- sub_dat[["3"]]$loss
cert_2 <- sub_dat[["3"]]$cert # cert[t]: outcome of a certain option on trial t
gamble_2 <- sub_dat[["3"]]$gamble# gamble[t]: choice on trial t. gamble[t]=1 --> chose a risky option. 0 --> chose a certain option.
