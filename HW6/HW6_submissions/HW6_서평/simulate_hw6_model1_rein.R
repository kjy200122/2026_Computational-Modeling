...
for (i in 1:num_subjs) {
  ...
  for (t in 1:num_trials)  {
    ...
    # update stimulus value (sv) of the chosen option, alpha pos and
    if (PE >= 0) {
...
# Write out data
write.table(all_data, file = "simul_data_hw6_model1_rein.txt", row.names = FALSE, col.names = TRUE, sep = "\t")
