...
# read the data file
dat = read.table("simul_data_hw6_model1_4.txt", header=T, sep="\t")
...
# run!
output = stan("hw6_model1_4.stan", data = dataList, pars = c("mu_alpha_pos", "mu_alpha_neg", "mu_beta", "alpha_pos", "alpha_neg", "beta"), #c("mu_alpha", "mu_beta", "alpha", "beta"),
