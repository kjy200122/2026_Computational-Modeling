...
source("simulate_hw6_model_2lr_2.R")
library(rstan)
# read the data file
dat = read.table("simul_data_hw6_model_2lr_2.txt", header=T, sep="\t")
...
# # save fitted model
# saveRDS(output, "output_2lr_2.rds")

# # load saved output
# output = readRDS("output_2lr_2.rds")
...
hist(x= alpha_neg_mean, breaks=5, main="mean of individual alpha_neg")
