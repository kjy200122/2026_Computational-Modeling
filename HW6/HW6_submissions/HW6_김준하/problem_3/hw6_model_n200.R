...
source("simulate_hw6_model_n200.R")

# read the data file
dat = read.table("simul_data_hw6_model_n200.txt", header=T, sep="\t")
...
# run!
output = stan("hw6_model1.stan", data = dataList, pars = c("mu_alpha", "mu_beta", "sigma","alpha", "beta"),
              iter = 2000, warmup=1000, chains=2, cores=2)

# save fitted model
# saveRDS(output, "output_n200.rds")

# load saved model
# output = readRDS("output_n200.rds")
