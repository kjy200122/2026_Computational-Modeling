...
# run!
output = stan("hw6_model2_non-hierarchical.stan", data = dataList, pars = c("alpha", "beta"), #c("mu_alpha", "mu_beta", "alpha", "beta"),
...
plot(simul_pars$alpha, alpha_mean, xlim=c(0, 0.5), ylim=c(0, 0.5),     
     xlab = "True Alpha",
     ylab = "Estimated Alpha (posterior mean)",
     main = "Parameter Recovery: Alpha - nonhier"); abline(0,1)
...
plot(simul_pars$beta, beta_mean, xlim=c(0, 4), ylim=c(0, 4),
     ...
     main = "Parameter Recovery: Beta- nonhier"); abline(0,1)
