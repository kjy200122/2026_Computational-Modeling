# Q5: grid approximation for ra_prospect (30 grids)
...
# posterior means
grid_mean_30$rho[n] <- sum(grid_results$rho * grid_results$posterior)
grid_mean_30$lambda[n] <- sum(grid_results$lambda * grid_results$posterior)
grid_mean_30$tau[n] <- sum(grid_results$tau * grid_results$posterior)
}
print(grid_mean_30)
