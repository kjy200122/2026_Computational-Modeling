...
# run! #non-hierarchical Stan model
output_nonhier = stan("hw6_model1_nonhier.stan", data = dataList, pars = c("alpha", "beta"), #c("mu_alpha", "mu_beta", "alpha", "beta"),
...
# traceplot
traceplot(output_nonhier, pars = "alpha")
traceplot(output_nonhier, pars = "beta")
...
plot(simul_pars$alpha, alpha_mean_nonhier, xlim=c(0, 0.5), ylim=c(0, 0.5)); abline(0,1)
arrows(x0=simul_pars$alpha, y0= alpha_mean_nonhier - alpha_sd_nonhier, y1= alpha_mean_nonhier + alpha_sd_nonhier, length=0.02, angle=90, code=3)

plot(simul_pars$beta, beta_mean_nonhier, xlim=c(0, 4), ylim=c(0, 4)); abline(0,1)
arrows(x0=simul_pars$beta, y0=beta_mean_nonhier-beta_sd_nonhier, y1=beta_mean_nonhier+beta_sd_nonhier, length=0.05, angle=90, code=3)
