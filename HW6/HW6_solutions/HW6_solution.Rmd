...
```{r q3_tab10, echo=FALSE, message=FALSE, fig.width=10, fig.height=13, out.width="100%"}
...
```{r q3_tab30, echo=FALSE, message=FALSE, fig.width=10, fig.height=13, out.width="100%"}
