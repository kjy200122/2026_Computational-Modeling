...
# run!
output_Q2 = stan("hw6_non_hier.stan", data = dataList, pars = c("alpha", "beta"),
...
save(output_Q2, file = "output_Q2.RData")

# traceplot
traceplot(output_Q2, pars = c("alpha"))
traceplot(output_Q2, pars = c("beta"))
