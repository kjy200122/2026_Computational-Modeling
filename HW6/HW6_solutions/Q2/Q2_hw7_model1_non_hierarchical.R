...
# run!
output_Q2 = stan("Q2/Q2_hw7_model1_non_hierarchical.stan", data = dataList, pars = c("alpha", "beta"),
                 iter = 2000, warmup=1000, chains=2, cores=4, seed = 2024)

save(output_Q2, file = "Q2/output_Q2.RData")
