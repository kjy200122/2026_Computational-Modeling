...
# run!
output_Q3 = stan("hw6_model1.stan", data = dataList, pars = c("mu_alpha", "mu_beta", "sigma", "alpha", "beta"),
...
save(output_Q3, file = "output_Q3.RData")

# traceplot
traceplot(output_Q3)
traceplot(output_Q3, pars = c("alpha"))
traceplot(output_Q3, pars = c("beta"))
