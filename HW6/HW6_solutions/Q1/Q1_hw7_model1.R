...
# run!
output_Q1 = stan("Q1/Q1_hw7_model1.stan", data = dataList, pars = c("mu_alpha", "mu_beta", "sigma", "alpha", "beta"),
              iter = 2000, warmup=1000, chains=2, cores=4, seed = 2025)
save(output_Q1, file = "Q1/output_Q1.RData")
