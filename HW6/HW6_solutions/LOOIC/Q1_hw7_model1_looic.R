...
# run!
output_Q1 = stan("LOOIC/Q1_hw5_model1_looic.stan", data = dataList, pars = c("mu_alpha", "mu_beta", "sigma", "alpha", "beta", "log_lik"),
              iter = 2000, warmup=1000, chains=4, cores=8, seed = 2024)
save(output_Q1, file = "LOOIC/output_Q1_looic.RData")
...
#####################################
load("LOOIC/output_Q1_looic.RData")

Q1_log_lik <- loo::extract_log_lik(stanfit = output_Q1, 
