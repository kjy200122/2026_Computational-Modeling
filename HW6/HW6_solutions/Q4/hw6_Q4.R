...
# read the data file
dat = read.table("simul_data_hw6_Q4.txt", header=T, sep="\t")
...
# run!
output_Q4 = stan("hw6_Q4.stan", data = dataList, pars = c("mu_alpha_pos", "mu_alpha_neg", "mu_beta", "sigma", 
...
save(output_Q4, file = "output_Q4.RData")

# traceplot
traceplot(output_Q4)
traceplot(output_Q4, pars = c("alpha"))
traceplot(output_Q4, pars = c("beta"))
