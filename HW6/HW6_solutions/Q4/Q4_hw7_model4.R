...
# read the data file
dat = read.table("simul_data_hw7_model4.txt", header=T, sep="\t")
...
# run! model is identical as Q4(1). Only difference is simulated data. 
output_Q4_model4 = stan("Q4/Q4_hw7_model3.stan", 
                 data = dataList, pars = c("mu_alpha_pos", "mu_alpha_neg", "mu_beta", "sigma", 
                                           "alpha_pos", "alpha_neg", "beta"),
                 iter = 2000, warmup=1000, chains=2, cores=2)

save(output_Q4_model4, file = "Q4/output_Q4_model4.RData")
