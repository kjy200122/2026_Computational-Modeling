...
param_hyp1_low <- c(0); param_hyp1_up <- c(1);  # lower and upper bounds of HYP1 model (0<b<5)
param_hyp2_low <- c(0,0); param_hyp2_up <- c(1,1);  # lower and upper bounds of HYP2 model (0<a<1, 0<b<5)
