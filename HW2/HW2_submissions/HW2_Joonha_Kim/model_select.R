...
source("MLE.R")   # source MLE._LSE.R code you programmed for HW1
...
# Generate summary
all_AIC = round(c(AIC_pow1, AIC_pow2, 
                  AIC_exp1, AIC_exp2, 
                  AIC_expow, AIC_hyp1, AIC_hyp2), 3)
all_BIC = round(c(BIC_pow1, BIC_pow2, 
                  BIC_exp1, BIC_exp2, 
                  BIC_expow, BIC_hyp1, BIC_hyp2), 3)
...
write.csv(modelcomp_summary, "./results/forget_model_comp.csv")
